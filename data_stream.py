...
def run_spark_job(spark):
    ...
    df = spark \
        ...
        .option("subscribe", "police.department.calls.service.log.v1")\
    ...
    distinct_table = distinct_table = service_table \
        .select(
                psf.col('original_crime_type_name'),
                psf.to_timestamp(psf.col('call_date_time')).alias('call_datetime'),
                psf.col('disposition'))

    agg_df = distinct_table.withWatermark("call_datetime", "60 minutes") \
